(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["tv-modal"] = factory();
	else
		root["tv-modal"] = factory();
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"f5f077b0-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/ButtonGroup.vue?vue&type=template&id=3cfb26f4&
var ButtonGroupvue_type_template_id_3cfb26f4_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('span',{staticClass:"inline-flex shadow-sm rounded"},[_vm._t("default")],2)}
var ButtonGroupvue_type_template_id_3cfb26f4_staticRenderFns = []


// CONCATENATED MODULE: ./src/ButtonGroup.vue?vue&type=template&id=3cfb26f4&
...
var ButtonGroup_component = normalizeComponent(
  ...
  ButtonGroupvue_type_template_id_3cfb26f4_render,
  ButtonGroupvue_type_template_id_3cfb26f4_staticRenderFns,
  false,
  null,
  null,
  null
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"5b28a9ec-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/ModalBase.vue?vue&type=template&id=2260dc64&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"fixed z-10 inset-0 overflow-y-auto",attrs:{"id":"ModalBase"}},[_c('div',{staticClass:"flex items-end justify-center min-h-screen pt-4 px-4 pb-40 text-center sm:block sm:p-0"},[_c('transition',{attrs:{"enter-active-class":"ease-out duration-300","enter-class":"opacity-0","enter-to-class":"opacity-100","leave-active-class":"ease-in duration-200","leave-class":"opacity-100","leave-to-class":"opacity-0"}},[(_vm.active)?_c('div',{staticClass:"fixed inset-0 transition-opacity",on:{"click":function($event){_vm.backdropDismiss && _vm.destroy()}}},[_c('div',{staticClass:"absolute inset-0 bg-black opacity-75"}),(_vm.backdropDismiss)?_c('div',{staticClass:"fixed top-0 right-0 p-3"},[_c('div',{staticClass:"p-3 cursor-pointer rounded-full transition ease-in-out duration-150 hover:bg-gray-800"},[_c('IconTimes',{staticClass:"w-6 h-6",attrs:{"primary":"text-gray-200","secondary":"text-gray-300"}})],1)]):_vm._e()]):_vm._e()]),_c('span',{staticClass:"hidden sm:inline-block sm:align-middle sm:h-screen"}),_c('transition',{attrs:{"enter-active-class":"ease-out duration-300","enter-class":"opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95","enter-to-class":"opacity-100 translate-y-0 sm:scale-100","leave-active-class":"ease-in duration-200","leave-class":"opacity-100 translate-y-0 sm:scale-100","leave-to-class":"opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95"}},[(_vm.active)?_c('div',{staticClass:"inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6",class:_vm.innerClass,attrs:{"role":"dialog","aria-modal":"true","aria-labelledby":"modal-headline"}},[_vm._t("default")],2):_vm._e()])],1)])}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/ModalBase.vue?vue&type=template&id=2260dc64&
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"5b28a9ec-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/GlobalModal.vue?vue&type=template&id=76facade&
var GlobalModalvue_type_template_id_76facade_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('ModalBase',{ref:"ModalBase",attrs:{"active":_vm.active,"destroyed":_vm.destroy,"backdropDismiss":_vm.backdropDismiss}},[_c('div',{staticClass:"sm:flex sm:items-start"},[(_vm.type!='clean')?_c('div',{staticClass:"mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full sm:mx-0 sm:h-10 sm:w-10",class:_vm.typeColors[_vm.type]},[(_vm.type === 'success')?_c('IconCheck',{staticClass:"h-5 w-5",attrs:{"primary":"text-green-600","secondary":"text-green-500"}}):_vm._e(),(_vm.type === 'info')?_c('IconInfo',{staticClass:"h-5 w-5",attrs:{"primary":"text-blue-600","secondary":"text-blue-500"}}):_vm._e(),(_vm.type === 'danger')?_c('IconBang',{staticClass:"h-5 w-5",attrs:{"primary":"text-red-600","secondary":"text-red-500"}}):_vm._e(),(_vm.type === 'warning')?_c('IconBang',{staticClass:"h-5 w-5",attrs:{"primary":"text-yellow-600","secondary":"text-yellow-500"}}):_vm._e()],1):_vm._e(),_c('div',{staticClass:"mt-3 text-center sm:mt-0 sm:text-left",class:{'sm:ml-4':_vm.type!=='clean'}},[_c('h3',{staticClass:"text-lg leading-6 font-medium text-gray-900",attrs:{"id":"modal-headline"}},[_vm._v(" "+_vm._s(_vm.title)+" ")]),(_vm.body)?_c('div',{staticClass:"mt-2"},[_c('p',{staticClass:"text-sm leading-5 text-gray-500"},[_vm._v(" "+_vm._s(_vm.body)+" ")])]):_vm._e()])]),(_vm.fields.length)?_c('div',{staticClass:"py-2"},_vm._l((_vm.fields),function(field,index){return _c('div',{key:field.name},[_c('label',{staticClass:"block text-sm font-medium text-gray-700",attrs:{"for":field.name}},[_vm._v(_vm._s(field.label))]),_c('div',{staticClass:"mt-1"},[_c('input',{directives:[{name:"model",rawName:"v-model",value:(field.value),expression:"field.value"}],ref:("field" + index),refInFor:true,staticClass:"shadow-sm focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md",attrs:{"type":"text","name":field.name,"id":field.name,"placeholder":field.placeholder?field.placeholder : '',"required":field.required},domProps:{"value":(field.value)},on:{"keyup":function($event){if(!$event.type.indexOf('key')&&_vm._k($event.keyCode,"enter",13,$event.key,"Enter")){ return null; }index === _vm.fields.length-1 && _vm.action('primary')},"input":function($event){if($event.target.composing){ return; }_vm.$set(field, "value", $event.target.value)}}})])])}),0):_vm._e(),(_vm.primary)?_c('div',{staticClass:"mt-5 sm:mt-4 sm:flex sm:flex-row-reverse"},[(_vm.primary)?_c('PushButton',{ref:"primary",staticClass:"flex w-full rounded-md shadow-sm sm:ml-3 sm:w-auto",attrs:{"theme":_vm.primary.theme},nativeOn:{"click":function($event){return _vm.action('primary')}}},[_vm._v(" "+_vm._s(_vm.primary.label)+" ")]):_vm._e(),(_vm.secondary)?_c('PushButton',{staticClass:"mt-3 flex w-full rounded-md shadow-sm sm:mt-0 sm:w-auto",attrs:{"theme":_vm.secondary.theme},nativeOn:{"click":function($event){return _vm.action('secondary')}}},[_vm._v(" "+_vm._s(_vm.secondary.label)+" ")]):_vm._e()],1):_vm._e()])}
var GlobalModalvue_type_template_id_76facade_staticRenderFns = []


// CONCATENATED MODULE: ./src/GlobalModal.vue?vue&type=template&id=76facade&
...
// EXTERNAL MODULE: ./node_modules/tv-button/dist/tv-button.umd.js
var tv_button_umd = __webpack_require__("02cc");
...
/* harmony default export */ var GlobalModalvue_type_script_lang_js_ = ({
  components: {
    ModalBase: ModalBase,
    PushButton: tv_button_umd["PushButton"],
    IconCheck: tv_icon_umd["IconCheck"],
    IconInfo: tv_icon_umd["IconInfo"],
    IconBang: tv_icon_umd["IconBang"]
  },
  props: {
    type: {
      type: String,
...
var GlobalModal_component = normalizeComponent(
  ...
  GlobalModalvue_type_template_id_76facade_render,
  GlobalModalvue_type_template_id_76facade_staticRenderFns,
  false,
  null,
  null,
  null
